...
python ../../software/SQANTI3/sqanti3_rescue.py ml --filter_class collapse_filter/B31_MLresult_classification.txt --refGTF /storage/gge/genomes/mouse_ref_NIH/reference_genome/mm39.ncbiRefSeq_SIRV.gtf --refFasta /storage/gge/genomes/mouse_ref_NIH/reference_genome/mm39_SIRV.fa --rescue_gtf collapse_QC/B31_corrected.gtf --rescue_isoforms collapse_QC/B31.fasta --refClassif reference_QC/reference_QC_classification.txt --mode full --random_forest collapse_filter/randomforest.RData -o collapse_rescue -d collapse_rescue  

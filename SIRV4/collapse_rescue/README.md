...
4. Select the appropriate genome assembly (SIRV4).
5. The SQANTI3 tracks will appear in your track list.

## 🔍 Advanced Filtering

This hub uses the bigBed 12+54 format with native UCSC filters. Right-click on the track and select "Configure" or "Filter" to access controls.
